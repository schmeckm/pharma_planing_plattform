...
export const planningApi = {
  ...
  getExecutability: () => req('get', '/planning/executability'),
  getLineScorecard: (params) => req('get', '/planning/line-scorecard', null, params),
  getPlanStability: (params) => req('get', '/planning/plan-stability', null, params),
  recordPlanningContribution: (payload) => req('post', '/planning/impact/contribution', payload),
